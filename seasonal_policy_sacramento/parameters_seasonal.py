...
import random
class Parameters:
    def __init__(self, N_BATT=5, BATT_CAP=5, N_SOLAR=0, AREA_SOLAR=2, ETA=0.949, SOL_EFFICIENCY=0.15*0.82, CITY='Sacramento', MAX_STAGE=8760, BASE_YEAR=2025, N_STATE_DISC=50, NO_GRID=False):
        self.N_BATT = N_BATT
