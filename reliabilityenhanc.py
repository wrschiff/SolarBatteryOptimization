...
if __name__ == "__main__":
    params = Parameters(N_BATT=5,N_SOLAR=20,CITY='Phoenix',STRUCTURE='B')  # Create a parameters instance
    ...
    # Print the cost and control sequence for stage 0 and state 0.51
    stage = 1
    state = 0.5102040816326531
    if (stage, state) in memo:
        print('yes')
    else:
        print(f"No entry in memo for stage {stage}, state {state}")    
